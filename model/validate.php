<?php
    class Validate {
        ...
        public function name($name, $value, $required = false) {
            $field = $this->fields->getField($name);
        ...
        public function address($name, $value, $required = false) {
            $field = $this->fields->getField($name);
        ...
        public function city($name, $value, $required = false) {
            $field = $this->fields->getField($name);
        ...
        public function age($name, $value, $required = false) {
            $field = $this->fields->getField($name);
